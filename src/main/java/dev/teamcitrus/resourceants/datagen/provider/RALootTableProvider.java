...
public class RALootTableProvider extends LootTableProvider {
    public RALootTableProvider(DataGenerator pGenerator) {
        super(pGenerator);
    }
    ...
    protected List<Pair<Supplier<Consumer<BiConsumer<ResourceLocation, LootTable.Builder>>>, LootContextParamSet>> getTables() {
        return ImmutableList.of(
                Pair.of(RABlockDrops::new, LootContextParamSets.BLOCK)
        );
    }
    ...
    private static class RABlockDrops extends BlockLoot {
        @Override
